...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    cluster_outputf << "cluster_idx" << "\t" << "average mz"<< "\t" << "average RT" << "\t" << "intensity sum" << "\t" << "num spectra" << "\t" <<"connected component index" << endl;
    ...
    for (int cluster_idx = 0; cluster_idx < cluster_content.size(); cluster_idx ++) {
        ...
        cluster_outputf << cluster_idx << "\t" << pepmass_sum_avg << "\t" << RT_avg << "\t" << intensity_sum << "\t" << num_spectra << "\t" << connected_component_index << endl;
